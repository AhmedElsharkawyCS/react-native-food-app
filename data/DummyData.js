...
export const CATEGORIES = [
  new CategorySchema("c1", "Italian", "#f5428d"),
  new CategorySchema("c2", "Quick & Easy", "#f54242"),
  new CategorySchema("c3", "Hamburgers", "#f5a442"),
  new CategorySchema("c4", "German", "#f5d142"),
  new CategorySchema("c5", "Light & Lovely", "#368dff"),
  new CategorySchema("c6", "Exotic", "#41d95d"),
  new CategorySchema("c7", "Breakfast", "#9eecff"),
  new CategorySchema("c8", "Asian", "#b9ffb0"),
  new CategorySchema("c9", "French", "#ffc7ff"),
  new CategorySchema("c10", "Summer", "#47fced"),
];
